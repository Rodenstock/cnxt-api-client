# CNXT.API.Client - the C# library for the CNXT®-Connector
...
- [IdentityModel](https://www.nuget.org/packages/IdentityModel/) - 5.2.0 or later
- [IdentityModel.OidcClient](https://www.nuget.org/packages/IdentityModel.OidcClient/) - 5.1.0 or later
...
```
nuget pack -Build -OutputDirectory out CNXT.API.Client.csproj
```
...
All URIs are relative to *http://localhost:8280/api* or *https://hub.cnxt.rodenstock.com*

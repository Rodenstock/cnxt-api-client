...
namespace CNXT.API.Client.Model
{
    ...
    public partial class SessionFilter :  IEquatable<SessionFilter>, IValidatableObject
    {
        ...
        /// <param name="hasDNEyeData">Check whether the session contains DNEye data or not..</param>
        /// <param name="hasImpressionISTData">Check whether the session contains ImpressionIST data or not..</param>
        /// <param name="hasRxData">Check whether the session contains Rx data or not..</param>
        public SessionFilter(string externalId = default(string), string patientId = default(string), DateTime? createdAfter = default(DateTime?), DateTime? updatedAfter = default(DateTime?), SessionState? state = default(SessionState?), bool? hasDNEyeData = default(bool?), bool? hasImpressionISTData = default(bool?), bool? hasRxData = default(bool?))
        {
            this.CreatedAfter = createdAfter;
            this.UpdatedAfter = updatedAfter;
            this.HasDNEyeData = hasDNEyeData;
            this.HasImpressionISTData = hasImpressionISTData;
            this.HasRxData = hasRxData;
        ...
        /// <summary>
        /// Check whether the session contains DNEye data or not.
        /// </summary>
        /// <value>Check whether the session contains DNEye data or not.</value>
        [DataMember(Name="hasDNEyeData", EmitDefaultValue=true)]
        public bool? HasDNEyeData { get; set; }

        /// <summary>
        /// Check whether the session contains ImpressionIST data or not.
        /// </summary>
        /// <value>Check whether the session contains ImpressionIST data or not.</value>
        [DataMember(Name="hasImpressionISTData", EmitDefaultValue=true)]
        public bool? HasImpressionISTData { get; set; }

        /// <summary>
        /// Check whether the session contains Rx data or not.
        /// </summary>
        /// <value>Check whether the session contains Rx data or not.</value>
        [DataMember(Name="hasRxData", EmitDefaultValue=true)]
        public bool? HasRxData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HasDNEyeData: ").Append(HasDNEyeData).Append("\n");
            sb.Append("  HasImpressionISTData: ").Append(HasImpressionISTData).Append("\n");
            sb.Append("  HasRxData: ").Append(HasRxData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(SessionFilter input)
        {
            ...
            return 
                ...
                (
                    this.HasDNEyeData == input.HasDNEyeData ||
                    (this.HasDNEyeData != null &&
                    this.HasDNEyeData.Equals(input.HasDNEyeData))
                ) && 
                (
                    this.HasImpressionISTData == input.HasImpressionISTData ||
                    (this.HasImpressionISTData != null &&
                    this.HasImpressionISTData.Equals(input.HasImpressionISTData))
                ) && 
                (
                    this.HasRxData == input.HasRxData ||
                    (this.HasRxData != null &&
                    this.HasRxData.Equals(input.HasRxData))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HasDNEyeData != null)
                    hashCode = hashCode * 59 + this.HasDNEyeData.GetHashCode();
                if (this.HasImpressionISTData != null)
                    hashCode = hashCode * 59 + this.HasImpressionISTData.GetHashCode();
                if (this.HasRxData != null)
                    hashCode = hashCode * 59 + this.HasRxData.GetHashCode();
                return hashCode;
            }
        }

...
namespace CNXT.API.Client.Model
{
    ...
    public partial class PatientFilter :  IEquatable<PatientFilter>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="externalId">External Id of a patient used in a 3rd party application to make it referenceable in CNXT.</param>
        ...
        public PatientFilter(string externalId = default(string), string search = default(string), string firstName = default(string), string lastName = default(string), DateTime? dateOfBirth = default(DateTime?), DateTime? sessionUpdatedAfter = default(DateTime?), DateTime? createdAfter = default(DateTime?), DateTime? updatedAfter = default(DateTime?))
        {
        ...
        /// <summary>
        /// External Id of a patient used in a 3rd party application to make it referenceable in CNXT
        /// </summary>
        /// <value>External Id of a patient used in a 3rd party application to make it referenceable in CNXT</value>

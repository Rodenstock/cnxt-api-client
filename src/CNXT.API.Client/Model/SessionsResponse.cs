...
{
    /// <summary>
    /// Represents a sessions response
    /// </summary>
    [DataContract]
    public partial class SessionsResponse :  IEquatable<SessionsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public SessionsResponse(List<SessionResponse> sessions = default(List<SessionResponse>), PaginationLink links = default(PaginationLink), PageInfo pageInfo = default(PageInfo))
        {
